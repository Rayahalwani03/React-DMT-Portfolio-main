              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+491633734785" className="hover:underline">
                      +49 163 3734785
                    </a>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {socialLinks.map((link) => (
                  <a
                    ...
                    className="flex items-center justify-center p-4 bg-white rounded-lg transition-all hover:bg-gray-900 hover:text-white group border border-gray-200"
                  >
                    <span className="text-gray-700 group-hover:text-white transition-colors">
                      {link.icon}
                    </span>
                    <span className="ml-2 font-medium text-gray-700 group-hover:text-white transition-colors text-sm">
                      {link.name}
                    </span>
                  </a>
                ))}
