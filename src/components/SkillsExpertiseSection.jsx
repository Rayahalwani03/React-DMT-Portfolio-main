...
const SkillsExpertiseSection = () => {
  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: ["Docker", "Git", "GDPR", "System Design"],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto font-light px-4">
            Technical competencies spanning full-stack development, data analytics, and modern software practices
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          {skillCategories.map((category, index) => (
            <div
              key={index}
              className="bg-gray-50 rounded-lg p-6 hover:bg-gray-100 transition-colors duration-300 border border-gray-200"
            >
